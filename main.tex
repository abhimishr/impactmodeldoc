...
%%% Render markdown
\usepackage{markdown}
% Render Markdown headings as plain bold text (no \section)
\markdownSetup{
  renderers = {
    headingOne   = {\par\noindent\textbf{#1}\par\vspace{-0.5\baselineskip}},
    headingTwo   = {\par\noindent\textbf{#1}\par\vspace{-0.5\baselineskip}},
    headingThree = {\par\noindent\textbf{#1}\par\vspace{-0.4\baselineskip}},
  }
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
...
%\includepdf[pages={1}, scale=1.01]{auxiliary/cover_page.pdf}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
