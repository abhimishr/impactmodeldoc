...
\begin{equation}
    ...
    \begin{aligned}
        ...
        * \prod_{cc \neq c} \left(\frac{PC_{c, cty} * (1 - CSE_{c, cty})}{PC0_{c, cty} * (1 - CSE_{c, cty})}\right)^{F_{\varepsilon}}
    \end{aligned}
\end{equation}
where: \textcolor{red}{\textbf{check $\prod$ part with Tim, it should evaluate to 1 in model. Also own price response is missing in model}}
\begin{conditions}
 QH       &   Household food demand \\
 ...
 \prod_{cc \neq c} \left(\frac{PC_{c, cty} * (1 - CSE_{c, cty})}{PC0_{c, cty} * (1 - CSE_{c, cty})}\right)^{F_{\varepsilon}}    & Cross price response \\
