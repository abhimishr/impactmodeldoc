...
\section{Decision Support System for Agrotechnology Transfer (DSSAT) Crop Systems Model}
...
\section{Linking DSSAT Crop Model Results to the International Model for Policy Analysis of Agricultural Commodities and Trade (IMPACT) Model}
...
\cmidrule{1-3}    \multicolumn{1}{c}{\multirow{9}[2]{*}{C3 crops}} & CERES rice & Rice  &  \\
          ...
          & Dryland cereals\tnote{a} & Barley, other cereals &  \\
          & Dryland pulses\tnote{b} & Chickpeas, pigeon peas, beans, cowpeas, lentils, other pulses &  \\
          & C3 average\tnote{c} & Cotton, sugar beets, tropical fruits, temperate fruits, vegetables, bananas, plantains, cocoa, coffee, tea, rapeseed, sunflower, oil palm, other oilseeds &  \\
          & C3 tolerant\tnote{d} & Cassava, sweet potato, yams, other roots and tubers, other &  \\
\cmidrule{1-3}    \multicolumn{1}{c}{\multirow{3}[2]{*}{C4 crops}} & CERES maize & Maize &  \\
          & CERES sorghum & Sorghum, millet &  \\
          & C4 tolerant\tnote{e} & Sugarcane &  \\
\cmidrule{1-3}    
\end{tabular}%
    \begin{tablenotes}[flushleft]\footnotesize
\item[a]    Dryland cereals are represented by one-half the negative effects (full positive) of climate change from CERES wheat results.
\item[b]    Dryland pulses are represented by one-half the negative effects (full positive) of the area-weighted average of the CROPGRO soybeans and CROPGRO groundnut results.
\item[c]    C3 average is represented as the area-weighted average of all five C3 DSSAT crop models used.
\item[d]    C3 tolerant is represented by one-half the negative effects (full positive) of the C3 average.
\item[e]    C4 tolerant is represented by one-half the negative effects (full positive) of climate change from CERES maize results.
    \end{tablenotes}
\end{threeparttable}
